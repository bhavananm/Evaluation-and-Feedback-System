...
$conn =  mysqli_Connect('localhost', 'root', '', 'userdb');
	...
	{
		 $sql1 = mysqli_query($conn,"Select count from qno where level = 'moderate'");
...
$id = $_GET['id'];
$v= $id+0.1;
$sql = mysqli_query($conn,"SELECT * FROM ds where id1 = '$v' ");
...
?>
<form action="result1.php?id=<?php echo($id);?>" method="post">
<center>
